...
export const TTL_COMMANDS: ReadonlyArray<TtlCommand> = [
  // ── 制御フロー ──────────────────────────────────────────────────────────────
  {
    ...
    descriptionJa: '<expression> が真(0以外)ならば、コマンド <statement> を実行する。',
  ...
  },
  {
    ...
    descriptionJa: '"for" と "next" の間のコマンドを、整数変数 <intvar> の値が <last> と等しくなるまで繰り返す。',
  ...
  },
  {
    ...
    descriptionJa: "'while' と 'endwhile' の間のコマンドを、<expression> が0以外である限り繰り返す。",
  ...
  },
  {
    ...
    descriptionJa: "'do' と 'loop' の間のコマンドを、条件式に従って繰り返す。",
  ...
  },
  {
    ...
    descriptionJa: "'until' と 'enduntil' の間のコマンドを、<expression> が0である限り繰り返す。",
  ...
  // ── 送受信 ───────────────────────────────────────────────────────────────────
  {
    ...
    descriptionJa: '<data> が文字列型の場合、文字列をホストへ送信させる。',
    snippet: "send '${1:text}'",
  },
  {
    name: 'sendln',
    ...
    descriptionJa: '文字列とそれに続く改行文字をホストへ送信させる。',
  ...
  },
  {
    ...
    descriptionJa: 'キーコード <key code> に割り当てられた機能を Tera Term に実行させる。',
  },
  {
    ...
    descriptionJa: '文字列とそれに続く改行文字を、すべての端末にブロードキャスト送信する。',
  },
  {
    ...
    descriptionJa: '文字列とそれに続く改行文字を、指定した端末にマルチキャスト送信する。',
  },
  {
    name: 'sendmulticast',
  ...
  // ── 受信・待機 ───────────────────────────────────────────────────────────────
  {
    ...
    descriptionJa: '文字列のうち一つがホストから送られてくるか、タイムアウトが発生するまで MACRO を停止させる。',
  ...
  },
  {
    ...
    descriptionJa: '文字列のうち一つを含む行をホストから受信するか、タイムアウトが発生するまで停止させる。',
  ...
  },
  {
    ...
    descriptionJa: '引数に指定したバイト数以上のデータが受信されるまで待つ。',
  },
  {
    name: 'waitrecv',
    ...
    descriptionJa: 'ある条件を満たす 1 つの文字列がホストから送られてくるか、タイムアウトが発生するまで停止させる。',
  },
  {
    name: 'waitregex',
    ...
    descriptionJa: '正規表現文字列のうち 1 つ以上を含む行をホストから受信するか、タイムアウトが発生するまで停止させる。',
  ...
  },
  {
    ...
    descriptionJa: 'ホストから受信したデータを <filename> で指定されたファイルに出力する。',
  },
  {
    name: 'flushrecv',
    signature: 'flushrecv',
    description: 'Discards all characters in the receive buffer.',
    descriptionJa: '受信バッファーに保存されているすべての文字を破棄する。',
  },
  // ── 接続管理 ─────────────────────────────────────────────────────────────────
  {
    name: 'connect',
    ...
    descriptionJa: 'MACRO が Tera Term とリンクされていない場合、Tera Term を起動して MACRO とリンクする。',
  ...
  },
  {
    ...
    descriptionJa: 'MACRO が Tera Term とリンクされていない場合、Cygwin に接続した Tera Term を起動して MACRO とリンクする。',
  },
  {
    name: 'disconnect',
    signature: 'disconnect [<confirm>]',
    description: 'Disconnects Tera Term from the host.',
    descriptionJa: 'Tera Term とホストの接続を切断する。',
  },
  {
    name: 'closett',
    signature: 'closett',
    description: 'Closes Tera Term and enters the unlinked state.',
    descriptionJa: 'Tera Term を終了させ、MACRO は非リンク状態に入る。',
  },
  {
    name: 'unlink',
    signature: 'unlink',
    description: 'MACRO enters the unlinked state and can no longer control the Tera Term window.',
    descriptionJa: 'このコマンド以降、MACRO は非リンク状態になり、その Tera Term ウィンドウを制御できなくなる。',
  },
  {
    name: 'testlink',
    signature: 'testlink',
    ...
    descriptionJa: 'リンクと接続の状態に応じた値をシステム変数 result に格納する。',
  },
  // ── 一時停止 ─────────────────────────────────────────────────────────────────
  {
    name: 'pause',
    ...
    descriptionJa: 'TTL の実行を <time> 秒だけ休止する。',
    snippet: 'pause ${1:1}',
  },
  {
    name: 'mpause',
    ...
    descriptionJa: 'TTL の実行を <time> ミリ秒だけ休止する。',
  ...
  },
  {
    ...
    descriptionJa: '入力ダイアログボックスを表示する。ユーザが入力した文字列はシステム変数 inputstr に格納される。',
  ...
  },
  {
    ...
    descriptionJa: '入力されるパスワードはそのまま表示されず、"****" のように表示される。',
  ...
  },
  {
    ...
    descriptionJa: 'Yes/No ダイアログを表示する。Yes なら result に 1、No なら 0 が格納される。',
  ...
  },
  {
    ...
    descriptionJa: 'リストボックスダイアログを表示する。選択されたインデックスが result に格納される。',
  ...
  },
  {
    ...
    descriptionJa: 'ステータスダイアログボックスを表示または更新する。',
  ...
  },
  {
    ...
    descriptionJa: '"statusbox" コマンドで開いたステータスダイアログボックスを閉じる。',
  },
  {
    name: 'bringupbox',
    signature: 'bringupbox',
    description: 'Brings the status box to the top of the Z order.',
    descriptionJa: 'ステータスボックスを最前面に表示する。',
  },
  {
    name: 'dirnamebox',
    ...
    descriptionJa: 'フォルダ選択ダイアログを表示する。選択されたフォルダが inputstr に格納される。',
  ...
  },
  {
    ...
    descriptionJa: 'ファイル選択ダイアログを表示する。選択されたファイル名が inputstr に格納される。',
  ...
  },
  {
    ...
    descriptionJa: 'マクロコマンドが表示するダイアログボックスの表示位置を変更する。',
  },
  // ── 文字列操作 ───────────────────────────────────────────────────────────────
  {
    name: 'sprintf',
    ...
    descriptionJa: 'C言語の書式指定にしたがって引数をフォーマットし、システム変数 inputstr に代入する。',
  ...
  },
  {
    ...
    descriptionJa: 'C言語の書式指定にしたがって引数をフォーマットし、文字列型変数 <strvar> に代入する。',
