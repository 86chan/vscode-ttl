...
```json
"ttl.format.normalizeOperatorSpacing": true,  // normalize whitespace around operators/commas
"ttl.format.alignCommentTables": true,        // align Markdown tables inside comments
"ttl.format.maxConsecutiveBlankLines": 1      // max consecutive blank lines (0 = unlimited)
```
